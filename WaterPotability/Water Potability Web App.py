...
loaded_model=pickle.load(open('C:\Users\Avinash\OneDrive\Desktop\movie\WaterPotability/model_trained.sav', 'rb')) 
...
def main():
    ...
    #giving title
    st.title('Water Portability Prediction Web App')
